...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse> getProductById(@PathVariable(name = "id") Long id) {
        ...
        productOptional.orElseThrow(() -> new ResourceNotFoundException("Produsul cu id-ul " + id + " na a fost gasit"));
    ...
    public ResponseEntity<ApiResponse> updateProduct(@RequestBody Product product) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Produsul a fost updated cu succes", updatedProduct));
    }
